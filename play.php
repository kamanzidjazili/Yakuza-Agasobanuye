...
<body>
    <style type="text/css">
        body{
    background-image: linear-gradient(rgba(5, 100, 148, 0.5),rgba(5, 100, 148, 0.5)),url(image/real.jpg);
    color: #fff;
        ...
        <div class="wrapper">
            ...
            <span class="material-icons">picture_in_picture_alt</span>
                  ...
                  <button class="fullscreen"><i class="fas fa-expand"></i></button>
                   <a href="#" class="fullscreen" download="<?php echo $link; ?>"><i class="fas fa-download"></i></a>
